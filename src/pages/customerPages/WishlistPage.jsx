    ...
    <div>
        {
            ...
            (
                <div className='w-11/12 sm:w-10/12 mt-8 mx-auto max-w-maxContent space-y-8' >
                    ...
                    <div className='grid grid-cols-2 gap-2 md:grid-cols-3 lg:grid-cols-4 md:gap-8'>
                    {
                        wishlistItems.map( (product,index)=>(
                            <div key={index} className='w-full sm:w-[220px] border border-gray-200 flex flex-col gap-2'>
                                <div className='relative h-[260px] sm:h-[294px]'>
                                 ...
                                 <div className='px-2 '>
                                    <p className='font-semibold'>{product?.name.length > 10 ? `${product.name.slice(0, 8)}..` : product.name}</p>
